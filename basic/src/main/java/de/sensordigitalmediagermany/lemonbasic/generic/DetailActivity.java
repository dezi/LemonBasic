...
public class DetailActivity extends ContentBaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        int imageWidth = Math.round(topFrame.getLayoutParams().width);
    ...
    private final View.OnClickListener askAndDownload = new View.OnClickListener()
    {
        ...
        public void onClick(View view)
        {
            if (ContentHandler.isMissingContent(Globals.displayContent))
            {
                DialogView.errorAlert(topFrame,
                        R.string.alert_no_asset_defined_title,
                        R.string.alert_no_asset_defined_info);
            }
            else
            {
